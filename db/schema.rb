...
ActiveRecord::Schema.define(version: 20170412221019) do
  ...
  create_table "shortened_urls", force: :cascade do |t|
    ...
    t.index ["shortened_url"], name: "index_shortened_urls_on_shortened_url", using: :btree
  end
  ...
  create_table "tag_topics", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tag"], name: "index_tag_topics_on_tag", using: :btree
  end
  ...
  create_table "taggings", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["shortened_id"], name: "index_taggings_on_shortened_id", using: :btree
